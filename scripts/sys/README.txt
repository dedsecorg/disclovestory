...
Because of partially lazyness, i have not made it to dismount every disk you put in.. only one.. okey, sorry. But what so? If you drag it out, well, you partially 
fucked up ONE disc, AND you only have to do the process again. No problem, problem solved! But also, this is because of volumes, and when you get over one volume, well, there can be a problem if you have multiple volumes in multiple disks.. So this is for not fucking that up also.
